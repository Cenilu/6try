document.addEventListener('DOMContentLoaded', function () {
    ...
    // Function to continuously update distance and time
    function continuousUpdate() {
        console.log("Starting continuous update...");
        // Update initially
    ...
    // Function to continuously watch user's position and update direction, distance, and time
        ...
        if (navigator.geolocation) {
            ...
            navigator.geolocation.watchPosition(function (position) {
                ...
                if (myLocationMarker) {
                    ...
                    updateDirection(); // Update direction whenever user's position changes
    ...
    watchUserPosition(); // Start watching user's position
    
    // Call the function to watch user's position
    watchUserPosition();
    ...
    continuousUpdate(); // Start continuous update of distance and time
});
